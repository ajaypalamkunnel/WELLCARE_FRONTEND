   ...
   <Header/>
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Explore Medical Departments</h1>
        <p className="text-gray-600 mt-2">
          Discover our specialized departments dedicated to providing exceptional healthcare services
        </p>
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
         ...
         >
           <div className="flex flex-col items-center">
             ...
             <h3 className="text-center font-medium text-gray-800">{department.name}</h3>
           </div>
         </div>
          ))}
        </div>

...
import { MapPin, Mail, Phone, Edit, X, Heart } from "lucide-react";
    ...
    <div className="w-full max-w-2xl mx-auto p-4">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        >
          ...
          {showDetails ? (
            <ShrinkIcon size={20} className="ml-2" />
          ) : (
          ...
          <div className="mt-6 space-y-4">
            <div className="bg-gray-50 p-4 rounded-md">
              <h4 className="font-bold mb-2 flex items-center">
                <Heart size={20} className="mr-2 text-red-500" /> Personal
                Information
              </h4>
              <div className="grid grid-cols-2 gap-2">
                <p>
                  <strong>Age:</strong> {user.personalInfo?.age || "N/A"}
                </p>
                <p>
                  <strong>Gender:</strong> {user.personalInfo?.gender || "N/A"}
                </p>
                <p>
                  <strong>Blood Group:</strong>{" "}
                  {user.personalInfo?.blood_group || "N/A"}
                </p>
                <p>
                ...
                <p>
                  ...
                  {user.personalInfo?.chronic_disease || "N/A"}
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded-md">
              <h4 className="font-bold mb-2 flex items-center">
                <MapPin
                  size={20}
                  className="mr-2 text-medicalring-medical-green-light"
                />{" "}
                Address Details
              </h4>
              <div className="grid grid-cols-2 gap-2">
    ...
    <div>
      ...
      <div className="bg-gray-50 p-6 rounded-md shadow-sm">
        <p className="text-gray-600 text-base">
          This is the {title.toLowerCase()} section.
        </p>
      </div>
    </div>
  );

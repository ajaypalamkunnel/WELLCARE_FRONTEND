...
const DoctorListing = () => {
  ...
  useEffect(() => {
    ...
    if (departmentFromQuery) {
      setFilters((prev) => ({ ...prev, department: departmentFromQuery }));
    }
  }, []);
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">
              <span className="font-medium">{totalDoctors}</span> medical
                ...
                {doctors.map((doctor) => (
                  ...
                  >
                    ...
                    <div className="px-5 pb-5 mt-auto">
                      <button
                        onClick={() =>
                          router.push(`/user/doctors/${doctor._id}`)
                        }
                        className="w-full bg-medical-green hover:bg-medical-green-dark text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2"
                      >
                        Book Appointment
                      </button>
                    </div>

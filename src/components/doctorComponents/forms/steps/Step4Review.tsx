      ...
      <div className="space-y-8">
        ...
        <div className="bg-gray-50 rounded-lg p-5 dark:bg-gray-800">
          ...
          <div className="space-y-6">
            <div>
              <h4 className="text-sm font-medium text-gray-500 mb-3 dark:text-gray-400">
                Education
              </h4>
              <div className="space-y-3">
                {formData.education &&
                  formData.education.map((edu: IEducation, index: number) => (
                    <div
                      key={index}
                      className="bg-white p-3 rounded-md shadow-sm dark:bg-gray-700"
                    >
            ...
            <div>
              ...
              <div className="space-y-3">
                {formData.certifications &&
                  formData.certifications.map((cert: ICertificate, index: number) => (
                    <div
                      key={index}
                      className="bg-white p-3 rounded-md shadow-sm dark:bg-gray-700"
                    >
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm dark:text-gray-300">
                            {cert.issuedBy}, {cert.yearOfIssue}
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-blue-700 dark:text-blue-300">
                ...
                application will be reviewed by the administration team.
              </p>
            </div>
          </div>
        </div>

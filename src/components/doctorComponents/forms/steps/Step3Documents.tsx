          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="form-label">
                Upload License Document (PDF or JPG)
              </label>
              <div
                onClick={(e) => {
                  e.stopPropagation();
                  licenseDocRef.current?.click();
                }}
              ...
              >
                <div className="space-y-1 text-center">
                  ...
                  <div className="flex text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <span className="font-medium text-deep-blue hover:text-blue-700 dark:text-blue-500">
                      Upload a file
                    </span>
                    <input
        ...
        <div className="p-6 bg-gray-50 rounded-lg dark:bg-gray-800">
          ...
          <div>
            ...
            {errors.IDProofDocument && (
              <p className="error-text mt-2">
                {errors.IDProofDocument.message}
              </p>
            )}
          </div>
        </div>
